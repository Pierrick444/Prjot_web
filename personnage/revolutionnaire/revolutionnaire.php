...
$st=$conn->prepare("SELECT * FROM revolutionnaire ORDER BY Appartenance ");
$st->execute();
...
<html>
    ...
    <input type="submit" name="ajout" value="Ajouter un personnage de One Piece">
    </form>
    </div>
...
<table class="table">
    ...
    <tr>
      ...
      <td><img src="../../image/<?php echo $row["Image"]?>" width=100px></td>
      <td><?php echo $row["Appartenance"]?></td>
      <td><?php echo $row["Arme"]?></td>
