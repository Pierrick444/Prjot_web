...
<body background="../image\One_Piece_Menu.jpg">
    ...
    <h1 id="Haut_de_page" style="text-align: center;">
        Les Produits One Piece
    </h1>
  </tbody>
</html>
<?php
require_once("connexion.php");
$st=$conn->prepare("SELECT * FROM collection ");
$st->execute();
...
<html>
    ...
    <input type="submit" name="ajout" value="Ajouter un produit One Piece">
    </form>
    </div>
...
<table class="table">
    ...
    <td><?php echo $row["Type"]?></td>
      ...
      <td><a href="<?php echo $row["Site"]?>" style="color:#000000" target="blank">Achat</a></td>
